...
public class Q5 {
    ...
    public static class Q5Mapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
    ...
    public static class Q5Reducer extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
    ...
    public static class Q5Combiner extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
